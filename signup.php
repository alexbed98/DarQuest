    ...
    if (count($messages) > 0) {
        ...
        if ($user === false) {
            ...
            if (AccountDAL::insertOne($connexion, $username, $prenom, $nom, $courriel, $motDePasse, $guid)) {
                ...
                <p><a style="text-decoration: underline; color: blue;" href="http://158.69.48.57/~darquest12/DarQuestMain-main/validate.php?guid=$guid">Validez votre courriel pour accéder a votre compte</a></p>
                HTML;
